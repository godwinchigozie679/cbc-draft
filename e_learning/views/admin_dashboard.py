...
def dashboard_admin(request):
    ...
    # Today Sales Unit
    today_order = UserCourse.objects.filter(date__date=today).count()
    
    # Today Commission
    today_earnings = UserCourse.objects.filter(
            date__date=today).aggregate(Sum('commission'))['commission__sum']
    
    # Total Sales Unit    
    
    all_time_order = UserCourse.objects.all().count()
    
    # Total Course Commission
    total_earnings = UserCourse.objects.all().aggregate(Sum('commission'))['commission__sum']    
    ...
    month_earnings = UserCourse.objects.filter(date__month=current_month
    ...
    return render(request, template_name='courses/dashboard/admin-dashboard/admin_dashboard.html', context=context) 
  

class AdminCourse(LoginRequiredMixin, ListView):
    ...
    template_name='courses/dashboard/admin-dashboard/admin_courses.html' 
