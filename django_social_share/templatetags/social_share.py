...
def post_to_twitter(context, text, obj_or_url=None, link_id='', link_text='',link_class=''):
    context = post_to_twitter_url(context, text, obj_or_url)

    request = context['request']
    url = _build_url(request, obj_or_url)
    tweet = _compose_tweet(text, url)
    context['link_id'] = link_id or 'tag-bg-hover'
    context['link_class'] = link_class  or 'social-share border text-decoration-none fw-bold text-primary'
    context['link_text'] = link_text or '<i class="p-2 m-2 text-center fab fa-twitter"></i>'
...
def post_to_facebook(context, obj_or_url=None, link_id='', link_text='',link_class=''):
    context = post_to_facebook_url(context, obj_or_url)
    context['link_id'] = link_id or 'tag-bg-hover'
    context['link_class'] = link_class  or 'rounded social-share border text-decoration-none fw-bold text-primary'
    context['link_text'] = link_text or '<i class="p-2 m-2 text-center fa-brands fa-facebook-f"></i>'
    return context
...
def post_to_gplus(context, obj_or_url=None, link_id='', link_text='',link_class=''):
    context = post_to_gplus_url(context, obj_or_url)
    context['link_id'] = link_id or 'tag-bg-hover'
    context['link_class'] = link_class  or 'social-share border text-decoration-none fw-bold text-primary'
    context['link_text'] = link_text or '<i class="p-2 m-2 text-center fab fa-google-plus-g"></i>'
    return context
...
def send_email(context, subject, text, obj_or_url=None, link_id='', link_text='',link_class=''):
    context = send_email_url(context, subject, text, obj_or_url)
    context['link_id'] = link_id or 'tag-bg-hover'
    context['link_class'] = link_class  or 'social-share border text-decoration-none fw-bold text-primary'
    context['link_text'] = link_text or '<i class="p-2 m-2 fw-bolder text-center fab fa-envelope"></i>'
    return context
...
def post_to_linkedin(context, obj_or_url=None,link_id='', link_text='',link_class=''):
    context = post_to_linkedin_url(context, obj_or_url)
    context['link_id'] = link_id or ''
...
def post_to_reddit(context, title, obj_or_url=None, link_id='', link_text='',link_class=''):
    context = post_to_reddit_url(context, title, obj_or_url)
    context['link_id'] = link_id or 'tag-bg-hover'
    context['link_class'] = link_class  or 'social-share border text-decoration-none fw-bold text-primary'
    context['link_text'] = link_text or '<i class="p-2 m-2 text-center fa-brands fa-reddit"></i>' 
    return context
...
def post_to_telegram(context, title, obj_or_url=None, link_id='', link_text='',link_class=''):
    context = post_to_telegram_url(context, title, obj_or_url)
    context['link_id'] = link_id or 'tag-bg-hover'
    context['link_class'] = link_class  or 'social-share border text-decoration-none fw-bold text-primary'
    context['link_text'] = link_text or '<i class="p-2 m-2 text-center fab fa-telegram-plane"></i>'
    return context
...
def post_to_whatsapp(context, obj_or_url=None, link_id='', link_text='',link_class=''):
    context = post_to_whatsapp_url(context, obj_or_url)
    context['link_id'] = link_id or 'tag-bg-hover'
    context['link_class'] = link_class  or 'rounded social-share border text-decoration-none fw-bold text-primary'
    context['link_text'] = link_text or '<i class="p-2 m-2 text-center fab fa-whatsapp"></i>'
    return context
